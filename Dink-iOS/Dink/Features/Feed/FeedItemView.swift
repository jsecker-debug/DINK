...
struct FeedItemView: View {
    ...
    private var iconName: String {
        ...
        case "poll_created": return "chart.bar.fill"
    ...
    private var iconColor: Color {
        switch item.activity.type {
        case "session_created": return .dinkTeal
        case "session_completed": return .dinkGreen
        case "member_joined": return .dinkNavy
        case "announcement": return .dinkOrange
        case "poll_created": return .purple
